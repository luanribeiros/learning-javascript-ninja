...
(function(){
    ...
    for(var cont = 0; cont <= 100; cont++){
        cont % 2 === 0 ? console.log('Números Pares ' + cont) : '';
    }
})();
...
var subtraction = calculator(25, 34);
var multiplication = calculator(32, 14);
var division = calculator(45, 5);
var mod = calculator(34, 6);
...
subtraction(function(){ return x - y; }() );

console.log( 'O resultado da multiplicação é:' );
multiplication(function(){ return x * y; }() );

console.log( 'O resultado da divisão é:' );
division(function(){ return x / y; }() );

console.log( 'O resto da divisão é:' );
mod(function(){ return x % y; }() );